...
* Request
  * Method: POST
  * URL: /spots/:id/?owner=current_user
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: /spots/?page=0&size=0&minLat=1.23&maxLat=1.23&minLng=3.21&maxLng=3.21&minPrice=99.99&maxPrice=999.99
  * Query Parameters
