  ...
  return (
    <>
      ...
      <ul className={ulClassName} ref={ulRef}>
        ...
        <li className="profile-li"><Link className="profile-link" to="/manage-spots">Manage Spots</Link></li>
        <li className="profile-li"><Link className="profile-link" to="/about">About</Link></li>
